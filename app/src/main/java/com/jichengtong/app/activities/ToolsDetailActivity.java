...
public class ToolsDetailActivity extends AppCompatActivity {
    ...
    private String generateWordHtml(ToolItem tool) {
        ...
        html.append("<html xmlns:o='urn:schemas-microsoft-com:office:office' ")
            ...
            .append("<style>\n")
            .append("@font-face{font-family:'FallbackSong';panose-1:2 1 6 0 3 1 1 1 1 1;}\n")
            .append("body{font-family:'Microsoft YaHei','PingFang SC','Hiragino Sans GB','WenQuanYi Micro Hei','Noto Sans CJK SC',SimSun,STSong,'宋体',Arial,sans-serif;font-size:12pt;line-height:1.8;margin:2cm;}\n")
